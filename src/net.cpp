...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Everestcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"everestcointools.com", "192.168.200.131"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"everestcointools.com", "testnet-seed.everestcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Everestcoin is probably already running."), addrBind.ToString().c_str());
        else
